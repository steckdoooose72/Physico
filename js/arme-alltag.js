/* ==========================================================================
   arme-alltag.js – Pilotmodus „Alltagsbewegung" (Arme)
   --------------------------------------------------------------------------
   Inhaltlich identisch zu js/arme-bewegung.js (gleiche Muskeln, gleiche
   ...
   („Du beugst den Arm, um etwas zum Mund zu führen.") statt des
   Fachbegriffs (Flexion). Siehe js/arme-bewegung.js für die ausführlichere
   ...
   ausdrücklich heraus, identisch zu js/arme-bewegung.js.
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Du beugst den Arm, um etwas zum Mund zu führen.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du streckst den Arm, um etwas wegzudrücken.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du drehst einen Schraubenzieher, um eine Schraube festzuziehen (rechtsdrehend).',
    name: 'Mm. pronatores',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du drehst einen Türgriff oder öffnest ein Marmeladenglas.',
    name: 'M. supinator',
    ids: ['FMA38514'],
...
try {
  ...
  console.log(`Arme-Alltag: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
