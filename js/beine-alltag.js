/* ==========================================================================
   beine-alltag.js – Pilotmodus „Alltagsbewegung" (Beine)
   --------------------------------------------------------------------------
   Inhaltlich identisch zu js/beine-bewegung.js (gleiche Muskeln, gleiche
   ...
   („Du steigst einen Berg hinauf.") statt des Fachbegriffs (Flexion).
   Siehe js/beine-bewegung.js für die ausführlichere Erklärung des Ablaufs.

   4 klare + 4 feine Fragen (8 insgesamt), nicht 2+2 wie bei den kleineren
   Regionen – "Beine" deckt Hüfte UND Fuß gleichzeitig ab.

   Der Umfang wird **vorab** gewählt, nicht pro Frage angezeigt:
     Einstieg    – die vier eindeutigen Hauptbewegungen (Hüfte + Fuß)
     Vertiefung  – dazu vier feinere Fragen (Ab-/Adduktion der Hüfte,
                   Supination/Pronation des Fußes)

   Hinweis zur Struktur-Benennung: js/beine-bewegung.js führt den großen
   Gesäßmuskel als eigene Struktur „M. gluteus maximus" (FMA22329) und die
   mittleren/kleinen Anteile separat als „M. gluteus medius/minimus"
   (FMA22331, FMA22333) – anders als js/beine-struktur.js, das alle drei
   zu einer Gruppe „Mm. glutei" zusammenfasst. Da für „M. gluteus maximus"
   eine eigene ID existiert, wird hier (identisch zu beine-bewegung.js)
   genau diese verwendet, keine Ausweich-Gruppe.
   ...
   Und wie in js/beine-struktur.js: nach der Antwort bleibt der richtige
...
/**
 * Der Fragenpool, durchgehend linke Seite (die Muskeln liegen nur links
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Du steigst einen Berg hinauf.',
    name: 'M. iliopsoas',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du richtest dich aus der Hocke auf.',
    name: 'M. gluteus maximus',
    ids: ['FMA22329'],
    funktion: 'Größter Gesäßmuskel, Hauptstrecker der Hüfte.',
  },
  {
    umfang: 'klar',
    bewegung: 'Du stellst dich auf die Zehenspitzen.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du gehst über unebenen Boden und hebst die Fußspitze an, um nicht zu stolpern.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du steigst seitlich über eine Absperrung.',
    name: 'M. gluteus medius/minimus',
    ids: ['FMA22331', 'FMA22333'],
    funktion: 'Stabilisiert das Becken beim Gehen; bei Schwäche kommt es zum Absinken des Beckens '
              + 'zur Gegenseite (Trendelenburg-Zeichen).',
  },
  {
    umfang: 'fein',
    bewegung: 'Du sitzt mit übereinandergeschlagenen Beinen.',
    name: 'Mm. adductores',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du balancierst auf unebenem Untergrund, der Fuß kippt leicht nach innen.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du gehst auf einem schmalen Grat, der Fuß kippt leicht nach außen.',
    name: 'Mm. fibulares',
...
// der Umfangswahl. Das Hüftbein liegt im Rumpf-Bündel, Femur/Tibia/Fibula/
// Fußknochen im Bein-Bündel.
const KNOCHEN_BUENDEL = ['skelett_rumpf', 'skelett_bein'];
// Die Muskeln kommen erst nach der Wahl dazu (deutlich größer). M. iliopsoas
// liegt im Rumpf-Bündel, die Gesäßmuskeln teils im Becken-, teils im
// Rumpf-Bündel, der Rest (Waden-/Unterschenkelmuskeln, Adduktoren) im
// Bein-Bündel.
const MUSKEL_BUENDEL = ['muskeln_rumpf', 'muskeln_becken', 'muskeln_bein'];
...
try {
  ...
  console.log(`Beine-Alltag: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
