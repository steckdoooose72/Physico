/* ==========================================================================
   beine-bewegung.js – Pilotmodus „Bewegung" (Beine)
   --------------------------------------------------------------------------
   Technisch identisch zu js/schulter-bewegung.js aufgebaut – siehe dort für
   die ausführlichere Erklärung des Ablaufs. Einziger inhaltlicher
   Unterschied: „Beine" deckt Hüfte UND Fuß gleichzeitig ab, deshalb hier
   4 klare + 4 feine Fragen (8 insgesamt) statt 4+3.

   Eine Bewegung steht als Text da („Die Hüfte wird gebeugt"), und der
   Muskel, der sie ausführt, wird aus vier Antworten gewählt.
   ...
   Keine Kennzeichnung an der einzelnen Frage – die Trennung passiert über
   die zwei Einstiegsknöpfe.
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Die Hüfte wird gebeugt.',
    name: 'M. iliopsoas',
  ...
  {
    umfang: 'klar',
    bewegung: 'Die Hüfte wird gestreckt.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Die Fußspitze wird nach unten gedrückt (Plantarflexion).',
    name: 'M. triceps surae',
    ids: ['FMA45961', 'FMA45958', 'FMA22559'],
    funktion: 'Wadenmuskulatur, senkt die Fußspitze, ermöglicht den Zehenstand.',
  },
  {
    umfang: 'klar',
    bewegung: 'Die Fußspitze wird nach oben gezogen (Dorsalextension).',
    name: 'M. tibialis anterior',
    ids: ['FMA22545'],
    funktion: 'Hebt die Fußspitze, wichtig um beim Gehen nicht mit den Zehen aufzusetzen.',
  },
  {
    umfang: 'fein',
    bewegung: 'Das Bein wird seitlich vom Körper abgespreizt (Abduktion).',
  ...
  {
    umfang: 'fein',
    bewegung: 'Das Bein wird zur Körpermitte herangeführt (Adduktion).',
    name: 'Mm. adductores',
  ...
  {
    umfang: 'fein',
    bewegung: 'Die Fußsohle wird nach innen gedreht (Supination/Inversion).',
    name: 'M. tibialis posterior',
    ids: ['FMA65019'],
    funktion: 'Klassischer Supinator des Fußes, unterstützt zusätzlich das Längsgewölbe.',
  },
  {
    umfang: 'fein',
    bewegung: 'Die Fußsohle wird nach außen gedreht (Pronation/Eversion).',
    name: 'Mm. fibulares',
    ids: ['FMA22553', 'FMA22555'],
    funktion: 'Drehen die Fußsohle nach außen und stabilisieren den äußeren Fußrand.',
  },
];
...
try {
  ...
  console.log(`Beine-Bewegung: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
