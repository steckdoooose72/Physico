/* ==========================================================================
   hals-alltag.js – Pilotmodus „Alltagsbewegung" (Hals)
   --------------------------------------------------------------------------
   Inhaltlich identisch zu js/hals-bewegung.js (gleiche Muskeln, gleiche
   ...
   („Du nickst zustimmend mit dem Kopf.") statt des Fachbegriffs (Flexion).
   Siehe js/hals-bewegung.js für die ausführlichere Erklärung des Ablaufs.
   ...
   RECHTS. Beim Rückwärtseinparken über die rechte Schulter schauen heißt
   also Kopfdrehung nach rechts, und genau deshalb wird hier der LINKE SCM
   als Mesh hervorgehoben (identisch zur Rotationsfrage in
   js/hals-bewegung.js).
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Du nickst zustimmend mit dem Kopf.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du schaust nach oben zur Decke.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du schaust beim Rückwärtseinparken über die rechte Schulter.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du neigst den Kopf zur Schulter, um dir das Ohr freizumachen.',
    name: 'Mm. scaleni',
...
try {
  ...
  console.log(`Hals-Alltag: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
