/* ==========================================================================
   knie-alltag.js – Pilotmodus „Alltagsbewegung" (Knie)
   --------------------------------------------------------------------------
   Inhaltlich identisch zu js/knie-bewegung.js (gleiche Muskeln, gleiche
   ...
   („Du steigst eine Treppe hoch.") statt des Fachbegriffs (Extension).
   Siehe js/knie-bewegung.js für die ausführlichere Erklärung des Ablaufs.

   Der Umfang wird **vorab** gewählt, nicht pro Frage angezeigt:
     Einstieg    – die zwei eindeutigen Hauptbewegungen (Streckung, Beugung)
     Vertiefung  – dazu zwei feinere Fragen zur Rotation im gebeugten Knie
   Das Knie ist anatomisch einfacher als die Schulter (im Wesentlichen ein
   Scharniergelenk mit geringer zusätzlicher Rotation) – deshalb hier bewusst
   nur vier statt sieben Fragen, keine künstliche Auffüllung.
   ...
   Und wie in js/knie-struktur.js: nach der Antwort bleibt der richtige
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Du steigst eine Treppe hoch.',
    name: 'Quadrizeps',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du beugst das Knie, um dich langsam auf einen Stuhl abzusetzen.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du sitzt mit gebeugtem Knie und drehst den Unterschenkel leicht nach innen, z. B. bei der Ballannahme mit der Innenseite des Fußes.',
    name: 'M. semitendinosus / M. semimembranosus',
    ids: ['FMA22359', 'FMA22449'],
    funktion: 'Zwei der drei ischiocruralen Muskeln, leiten zusätzlich die Innenrotation des gebeugten Knies ein.',
  },
  {
    umfang: 'fein',
    bewegung: 'Du sitzt mit gebeugtem Knie und drehst den Unterschenkel leicht nach außen.',
    name: 'M. biceps femoris',
    ids: ['FMA45889', 'FMA45892'],
    funktion: 'Dritter ischiocruraler Muskel, leitet zusätzlich die Außenrotation des gebeugten Knies ein.',
  },
];

// Für das Skelett als ruhiger Hintergrund – lädt schnell, steht schon hinter
// der Umfangswahl.
const KNOCHEN_BUENDEL = ['skelett_bein'];
// Die Muskeln kommen erst nach der Wahl dazu (deutlich größer).
const MUSKEL_BUENDEL = ['muskeln_bein'];
 ...
 * js/knie-struktur.js, js/knie-bewegung.js und js/knie-verletzung.js.
 */
...
try {
  ...
  console.log(`Knie-Alltag: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
