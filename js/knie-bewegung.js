/* ==========================================================================
   knie-bewegung.js – Pilotmodus „Bewegung" (Knie)
   --------------------------------------------------------------------------
   Zweites der drei geplanten Knie-Module (nach knie-struktur.js, vor dem
   Verletzungsmechanismus). Technisch identisch zu js/schulter-bewegung.js
   aufgebaut – siehe dort für die ausführlichere Erklärung des Ablaufs.

   Eine Bewegung steht als Text da („Das Knie wird gestreckt"), und der
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Das Knie wird gestreckt (Extension).',
    name: 'Quadrizeps',
  ...
  {
    umfang: 'klar',
    bewegung: 'Das Knie wird gebeugt (Flexion).',
  ...
  {
    umfang: 'fein',
    bewegung: 'Das gebeugte Knie wird nach innen gedreht (Innenrotation) – nur im gebeugten Zustand überhaupt möglich.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Das gebeugte Knie wird nach außen gedreht (Außenrotation) – nur im gebeugten Zustand überhaupt möglich.',
...
try {
  ...
  console.log(`Knie-Bewegung: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
