/* ==========================================================================
   kopf-bewegung.js – Pilotmodus „Bewegung" (Kopf)
   --------------------------------------------------------------------------
   Zweites der Kopf-Module (nach kopf-struktur.js). Technisch identisch zu
   js/knie-bewegung.js aufgebaut – siehe dort für die ausführlichere
   Erklärung des Ablaufs.

   Eine Bewegung steht als Text da („Der Mund wird geöffnet"), und der
   Muskel, der sie ausführt, wird aus vier Antworten gewählt.

   Der Umfang wird **vorab** gewählt, nicht pro Frage angezeigt:
     Einstieg    – die zwei eindeutigen Hauptbewegungen (Öffnen, Schließen)
     Vertiefung  – dazu zwei feinere Fragen zu Retrusion und Laterotrusion
   Vorschub (Protrusion) ist bewusst NICHT als eigene Frage dabei: die
   Antwort (M. pterygoideus lateralis) wäre identisch zur Mundöffnungs-Frage
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Der Mund wird geöffnet.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Der Mund wird geschlossen.',
    name: 'M. masseter',
  ...
  {
    umfang: 'fein',
    bewegung: 'Der Unterkiefer wird nach hinten gezogen (Retrusion).',
    name: 'M. temporalis',
    ids: ['FMA49008'],
  ...
  {
    umfang: 'fein',
    bewegung: 'Der Unterkiefer wird seitlich bewegt (Laterotrusion).',
...
try {
  ...
  console.log(`Kopf-Bewegung: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
