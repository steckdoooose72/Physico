/* ==========================================================================
   rumpf-alltag.js – Pilotmodus „Alltagsbewegung" (Rumpf)
   --------------------------------------------------------------------------
   Inhaltlich identisch zu js/rumpf-bewegung.js (gleiche Muskeln, gleiche
   ...
   („Du beugst dich nach vorn, um dir die Schuhe zuzubinden.") statt des
   Fachbegriffs (Flexion). Siehe js/rumpf-bewegung.js für die ausführlichere
   ...
   externus für eine Drehung nach rechts) – identisch zur Rotationsfrage in
   js/rumpf-bewegung.js.
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Du beugst dich nach vorn, um dir die Schuhe zuzubinden.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du richtest dich nach dem Bücken wieder auf.',
    name: 'M. multifidus',
    ids: ['FMA22879'],
  ...
  {
    umfang: 'fein',
    bewegung: 'Du schaust beim Rückwärtsfahren über die Schulter, der ganze Oberkörper dreht mit.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du greifst seitlich nach etwas, das neben dir auf dem Boden liegt.',
...
try {
  ...
  console.log(`Rumpf-Alltag: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
