/* ==========================================================================
   schulter-alltag.js – Pilotmodus „Alltagsbewegung" (Schulter)
   --------------------------------------------------------------------------
   Inhaltlich identisch zu js/schulter-bewegung.js (gleiche Muskeln, gleiche
   ...
   („Du greifst ins oberste Regal …") statt des Fachbegriffs (Abduktion).
   Siehe js/schulter-bewegung.js für die ausführlichere Erklärung des Ablaufs.
   ...
   Ablauf wie in den anderen Schulter-Piloten:
...
const BEWEGUNGEN = [
  {
    umfang: 'klar',
    bewegung: 'Du greifst ins oberste Regal, um etwas herunterzuholen.',
    name: 'Deltamuskel',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du ziehst einen Reißverschluss auf deinem Rücken hoch.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du kämmst dir mit der Hand über den Hinterkopf durch die Haare.',
  ...
  {
    umfang: 'klar',
    bewegung: 'Du drückst mit ausgestrecktem Arm eine Tür zu, indem du den Arm zum Körper führst.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du ziehst dich an einer Reckstange nach oben.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du hebst den Arm ganz langsam seitlich an, noch bevor er wirklich seitlich abgespreizt ist.',
  ...
  {
    umfang: 'fein',
    bewegung: 'Du drückst mit der Hand seitlich gegen eine Wand, während der Ellenbogen am Körper bleibt.',
    name: 'M. teres major',
...
try {
  ...
  console.log(`Schulter-Alltag: ${BEWEGUNGEN.filter((b) => b.umfang === 'klar').length} klar, `
